...
void draw_cube() {
  ...
  for(int i = 0; i < 12; i++) {
    display.drawLine((int)(x_zero + v[edges[i][0]].x), (int)(y_zero + v[edges[i][0]].y),
                    (int)(x_zero + v[edges[i][1]].x), (int)(y_zero + v[edges[i][1]].y), ON);
  }
}
